                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            ...
                            <div v-if="wallets?.data?.length === 0" class="text-center py-12">
                                <UserGroupIcon class="mx-auto h-12 w-12 text-gray-400" />
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No wallets found</h3>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="wallet in wallets?.data" :key="wallet.id">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <div
                                                            ...
                                                            {{ wallet.customer.name.charAt(0).toUpperCase() }}
                                                        </div>
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">{{ wallet.wallet_identifier }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-700 font-bold">{{ wallet.balance }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!-- Pagination -->
                                <div class="mt-4">
                                    <div v-if="wallets?.links?.length > 3" class="flex flex-wrap -mb-1">
                                        <template v-for="(link, key) in wallets?.links" :key="key">
